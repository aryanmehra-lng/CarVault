        ...
        >
          ...
          <View style={styles.topBar}>
            ...
            <View style={styles.brandBadge}>
              ...
              <Text style={styles.brandBadgeText}>CARVAULT VIP</Text>
            </View>
          ...
          <View style={styles.heroSection}>
            ...
            <Text style={styles.heroSubtitle}>
              Authenticate your driver profile to access synchronized garage telemetry, custom spec cards, and VIP listings.
            </Text>

            {/* Feature Highlights Strip */}
            <View style={styles.featureStrip}>
              <View style={styles.featureTag}>
                <Text style={styles.featureTagText}>🔒 256-BIT VAULT</Text>
              </View>
              <View style={styles.featureTag}>
                <Text style={styles.featureTagText}>⚡ TELEMETRY SYNC</Text>
              </View>
              <View style={styles.featureTag}>
                <Text style={styles.featureTagText}>🏎️ CURATED FLEET</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.formCard}>
            ...
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel="Autofill demo credentials"
            >
              <View style={styles.demoCardLeft}>
                ...
                <View>
                  <Text style={styles.demoCardTitle}>Demo Collector Pass</Text>
                  <Text style={styles.demoCardSubtitle}>dom@toretto.fast</Text>
                </View>
              </View>
            ...
            <View style={styles.securityRow}>
              ...
              <Text style={styles.securityText}>
                Encrypted biometric & tokenized session
              </Text>
            </View>
          </View>
          ...
          <View style={styles.footerRow}>
            <Text style={styles.footerText}>New collector? </Text>
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={navigateToSignup}
              hitSlop={styles.hitSlopArea}
            >
              <Text style={styles.signUpLink}>Apply for VIP Access</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
